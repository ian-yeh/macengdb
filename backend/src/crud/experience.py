...
def get_experiences_by_company_id(
...
def get_experiences_by_user_id(db: Session, user_id: int) -> List[ExperienceModel]:
    ...
    return db.query(ExperienceModel).filter(ExperienceModel.user_id == user_id).all()
...
def create_experience(
    db: Session, experience: ExperienceCreate, user_id: int
) -> ExperienceModel:
...
def create_experience_anonymous(
    db: Session, experience: ExperienceSubmit
) -> ExperienceModel:
...
def update_experience(
    db: Session, experience_id: int, experience: ExperienceUpdate
) -> Optional[ExperienceModel]:
