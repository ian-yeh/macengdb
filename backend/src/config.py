...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = "postgresql+psycopg2://user:password@localhost:5432/db" # Example default
    ASYNC_DATABASE_URL: str = "postgresql+asyncpg://user:password@localhost:5432/db" # Example default
