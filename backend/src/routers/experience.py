...
@router.patch("/admin/experiences/{experience_id}/approve", response_model=ExperienceResponse)
...
@router.patch("/admin/experiences/{experience_id}/reject", response_model=ExperienceResponse)
