...
export default function PrivacyPage() {
  return (
    <div className="min-h-screen py-8 md:py-12 px-4 md:px-8 max-w-4xl mx-auto flex flex-col">
      ...
      <h1 className="font-playfair text-4xl md:text-6xl font-bold text-[#222] dark:text-white leading-[1.1] mb-6">Privacy <span className="text-maceng-maroon dark:text-maceng-orange italic">Policy</span></h1>
